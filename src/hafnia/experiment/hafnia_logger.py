...
class HafniaLogger:
    ...
    def __init__(self, log_dir: Union[Path, str] = "./.data"):
        ...
        path_file.write_text(how_to_store_model_instructions())
...
def how_to_store_model_instructions() -> str:
    instructions = textwrap.dedent(
        ...
        to ensure they are properly stored and accessible after training.
